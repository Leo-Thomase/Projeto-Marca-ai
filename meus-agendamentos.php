		...
		$.ajax({
			...
			success: function (mensagem) {			
				...
				let a= document.createElement('a');
			          a.target= '_blank';
a.href = 'http://api.whatsapp.com/send?1=pt_BR&phone=<?= $tel_whatsapp ?>&text=*Atenção:* _Agendamento Cancelado_ %0AFuncionário: *' + encodeURIComponent(nome_func) + '* %0AServiço: *' + encodeURIComponent(nome_serv) + '* %0AData: *' + encodeURIComponent(dataFormatada) + '* %0AHora: *' + encodeURIComponent(horaFormatada) + '* %0ACliente: *' + encodeURIComponent(nome) + '*';
			          a.click();
			          return;		
