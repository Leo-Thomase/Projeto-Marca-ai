...
<div class="container ">
    <div class="row vertical-offset-100">
    	<div class="col-md-4 col-md-offset-4">
    		<div class="panel panel-default form-login" style="opacity:0.9; border-radius: 20px; background: black;">
			  	<div class="panel-heading" align="center" style="border-top-right-radius: 20px; background: black; border-color: black; border-top-left-radius: 20px">
				<!-- <img src="img/logo.png" width="250px">-->
			  	...
			  	<div class="panel-body">
                    ...
                    <fieldset>
			    		...
			    		<input class="btn btn-lg btn-block" style="background-color: gray; color: white;" type="submit" value="Login">
			    	</fieldset>

			    	<p class="recuperar"><a title="Clique para recupearar a senha" href="" data-toggle="modal" data-target="#exampleModal" style="color: white;">Recuperar Senha</a></p>
			      	</form>
			    </div>
			</div>
		</div>
