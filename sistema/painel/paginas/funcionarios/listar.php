...
<td>
		<big><a href="#" onclick="editar('{$id}','{$nome}', '{$email}', '{$telefone}', '{$cpf}', '{$endereco}', '{$foto}', '{$atendimento}', '{$tipo_chave}', '{$chave_pix}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>

		<big><a href="#" onclick="mostrar('{$nome}', '{$email}', '{$cpf}', '{$senha}', '{$dataF}', '{$ativo}', '{$telefone}', '{$endereco}', '{$foto}', '{$atendimento}', '{$tipo_chave}', '{$chave_pix}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, email, telefone, cpf, endereco, foto, atendimento, tipo_chave, chave_pix){
		$('#id').val(id);
		$('#nome').val(nome);
		$('#email').val(email);
...
<script type="text/javascript">
	function mostrar(nome, email, cpf, senha, data, ativo, telefone, endereco, foto, atendimento, tipo_chave, chave_pix){
