...
if($id == ""){
	...
	$query = $pdo->prepare("UPDATE $tabela SET nome = :nome, valor_compra = :valor_compra, valor_venda = :valor_venda, descricao = :descricao, foto = '$foto', nivel_estoque = '$nivel_estoque' WHERE id = '$id'");
}
