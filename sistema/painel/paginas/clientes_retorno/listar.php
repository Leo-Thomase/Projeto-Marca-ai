...
<td>
		...
		<big><a href="#" onclick="mostrar('{$nome}', '{$telefone}', '{$cartoes}', '{$data_cadF}', '{$data_retornoF}', '{$nome_servico}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, telefone, cartoes){
		$('#id').val(id);
		$('#nome').val(nome);		
...
<script type="text/javascript">
	function mostrar(nome, telefone, cartoes, data_cad, retorno, servico){
