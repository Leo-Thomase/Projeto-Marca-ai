...
<div class="main-page">
	...
	<div class="col_3">
        ...
        <div class="col-md-3 widget widget1">
            <div class="r3_counter_box">
                <i class="pull-left fa fa-calendar icon-rounded" style="background: gray;"></i>
                <div class="stats">
                        <h5><strong><big><big><?php echo $total_agendamentos_hoje  ?></big></big></strong></h5>

                    </div>
                    <hr style="margin-top:10px">
                    <div align="center"><span>Agendamentos do dia</span></div>
            </div>
        </div>
        </a>
...
<!-- for index page weekly sales java script -->
    ...
    <script>
        ...
        var graphdata1 = {
            ...
            title: "Despesas",
            values: [
            { X: "Jan", Y: parseFloat(saldo_mes[0]) },
            { X: "Fev", Y: parseFloat(saldo_mes[1]) },
            { X: "Mar", Y: parseFloat(saldo_mes[2]) },
            { X: "Abr", Y: parseFloat(saldo_mes[3]) },
            { X: "Mai", Y: parseFloat(saldo_mes[4]) },
            { X: "Jun", Y: parseFloat(saldo_mes[5]) },
            { X: "Jul", Y: parseFloat(saldo_mes[6]) },
            { X: "Ago", Y: parseFloat(saldo_mes[7]) },
            { X: "Set", Y: parseFloat(saldo_mes[8]) },
            { X: "Out", Y: parseFloat(saldo_mes[9]) },
            { X: "Nov", Y: parseFloat(saldo_mes[10]) },
            { X: "Dez", Y: parseFloat(saldo_mes[11]) },
        ...
        var graphdata2 = {
            ...
            title: "Vendas",
            values: [
            { X: "Jan", Y: parseFloat(saldo_mes_venda[0]) },
            { X: "Fev", Y: parseFloat(saldo_mes_venda[1]) },
            { X: "Mar", Y: parseFloat(saldo_mes_venda[2]) },
            { X: "Abr", Y: parseFloat(saldo_mes_venda[3]) },
            { X: "Mai", Y: parseFloat(saldo_mes_venda[4]) },
            { X: "Jun", Y: parseFloat(saldo_mes_venda[5]) },
            { X: "Jul", Y: parseFloat(saldo_mes_venda[6]) },
            { X: "Ago", Y: parseFloat(saldo_mes_venda[7]) },
            { X: "Set", Y: parseFloat(saldo_mes_venda[8]) },
            { X: "Out", Y: parseFloat(saldo_mes_venda[9]) },
            { X: "Nov", Y: parseFloat(saldo_mes_venda[10]) },
            { X: "Dez", Y: parseFloat(saldo_mes_venda[11]) },
          ...
          var graphdata3 = {
            ...
            title: "Serviços",
            values: [
            { X: "Jan", Y: parseFloat(saldo_mes_servico[0]) },
            { X: "Fev", Y: parseFloat(saldo_mes_servico[1]) },
            { X: "Mar", Y: parseFloat(saldo_mes_servico[2]) },
            { X: "Abr", Y: parseFloat(saldo_mes_servico[3]) },
            { X: "Mai", Y: parseFloat(saldo_mes_servico[4]) },
            { X: "Jun", Y: parseFloat(saldo_mes_servico[5]) },
            { X: "Jul", Y: parseFloat(saldo_mes_servico[6]) },
            { X: "Ago", Y: parseFloat(saldo_mes_servico[7]) },
            { X: "Set", Y: parseFloat(saldo_mes_servico[8]) },
            { X: "Out", Y: parseFloat(saldo_mes_servico[9]) },
            { X: "Nov", Y: parseFloat(saldo_mes_servico[10]) },
            { X: "Dez", Y: parseFloat(saldo_mes_servico[11]) },
