...
$query = $pdo->prepare("UPDATE config SET nome = :nome, email = :email, telefone_whatsapp = :whatsapp, telefone_fixo = :telefone_fixo, endereco = :endereco, logo = 'logo.png', icone = 'favicon.png', logo_rel = 'logo_rel.jpg', tipo_rel = '$tipo_rel', instagram = :instagram, texto_rodape = :texto_rodape, img_banner_index = '$img_banner_index', icone_site = 'favicon.png', imagem_sobre = '$img_sobre', texto_sobre = :texto_sobre, mapa = :mapa, quantidade_cartoes = '$quantidade_cartoes', texto_fidelidade = :texto_fidelidade, msg_agendamento = :msg_agendamento, cnpj = :cnpj, cidade = :cidade, agendamento_dias = '$agendamento_dias', itens_pag = '$itens_pag'");
