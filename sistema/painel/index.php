...
<body class="cbp-spmenu-push">
	<div class="main-content">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="sidebar-menu">
							...
							<?php if (@$atendimento == 'Sim') { ?>
								...
								<li class="treeview">
									<a href="index.php?pag=feriados">
										<i class="fa fa-calendar"></i> <span>Feriados</span>
									</a>
								</li>

								<li><a href="index.php?pag=horarios"><i class="fa fa-clock-o"></i> Meus Horários</a></li>
								...
								<li class="treeview">
									...
									<ul class="treeview-menu">
										...
										<li><a href="index.php?pag=dias"><i class="fa fa-angle-right"></i>Dias Semana</a>
										</li>
								...
								<li class="treeview <?php echo $menu_cadastros ?>">
									...
									<ul class="treeview-menu">
										...
										<li class="<?php echo @$grupos ?>"><a href="index.php?pag=grupos"><i
													class="fa fa-angle-right"></i>Grupo Acessos</a></li>

										<li class="<?php echo @$acessos ?>"><a href="index.php?pag=acessos"><i
													class="fa fa-angle-right"></i>Acessos</a></li>
								...
								<li class="treeview <?php echo $menu_produtos ?>">
									...
									<ul class="treeview-menu">
										...
										<li class="<?php echo @$saidas ?>"><a href="index.php?pag=saidas"><i
													class="fa fa-angle-right"></i>Saídas</a></li>

										<li class="<?php echo @$entradas ?>"><a href="index.php?pag=entradas"><i
													class="fa fa-angle-right"></i>Entradas</a></li>
								...
								<li class="treeview <?php echo $menu_financeiro ?>">
									...
									<ul class="treeview-menu">
										...
										<li class="<?php echo @$vendas ?>"><a href="index.php?pag=vendas"><i
													class="fa fa-angle-right"></i>Vendas</a></li>

										<li class="<?php echo @$compras ?>"><a href="index.php?pag=compras"><i
													class="fa fa-angle-right"></i>Compras</a></li>
		...
		<!--footer-->
		<div class="footer">
			<p> Desenvolvido por <a href="https://www.instagram.com/_higorcamillo/" target="_blank">Marca Ai</a>
			</p>
		</div>
		<!--//footer-->
	</div>
